...
See an example of configuration with topology : [cassandracluster-demo-gke-zone.yaml](https://raw.githubusercontent.com/Orange-OpenSource/casskop/master/samples/cassandracluster-demo-gke-zone.yaml)
